...
<body>
    ...
    <div class="card">
        ...
        <form action="/jobs" method="POST">
            <?php echo csrf_field(); ?> <input type="text" name="title" placeholder="اسم الوظيفة (مثلاً: Cyber Security Intern)" required>
...
</html><?php /**PATH C:\Users\HP\Downloads\-AI-Driven-Smart-Recruitment-Interview-Management-System-main\Backend\resources\views/create-job.blade.php ENDPATH**/ ?>